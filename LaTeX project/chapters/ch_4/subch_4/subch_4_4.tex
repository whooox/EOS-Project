...
\normalsize{To compare between the old and new tile design but also validate the FE model, calculating the surface integral can be of use. This idea behind this is to check for energy conservation after integration the heat flux of the \acrshort{ECRH} beam on the tile surface. }