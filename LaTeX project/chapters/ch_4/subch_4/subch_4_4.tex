...
\begin{table*}\centering
    ...
    $-$ & $[W \ m^{-2}]$ & $[m^{-2}]$ & $[m]$ & $[m]$\\
    \midrule
    $\makecell{Axisymmetric \\ heat flux \\ distribution \\ $[cyl. CS]$}$ & $473957$ & $519,69$ & $0,035$ & $0,035$\\
    $\makecell{Axisymmetric \\ heat flux \\ distribution \\ $[car. CS]$}$ & $473957$ & $519,69$ & $0,035$ & $0,035$\\
    $\makecell{Non-axisymmetric \\ heat flux \\ distribution \\ $[car. CS]$}$ & $243948$ & $267,5$ & $0,035$ & $0,068$\\
\bottomrule
\end{tabular}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=1\textwidth]{figures/apdlscript3.png}
